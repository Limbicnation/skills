...
---
name: godot-expert
description: Comprehensive Godot 4.x game development patterns and best practices. Use when working with Godot projects, GDScript, scenes (.tscn), physics, input handling, UI, animation, audio, performance optimization, multi-platform export, and GDUnit testing.
---
...
Godot 4.x supports HTML5, Android, iOS, Windows, macOS, and Linux exports. Use platform detection to adapt controls and features:
...
**See:** `references/export-platforms.md` for complete export setup, configuration, and platform-specific code
